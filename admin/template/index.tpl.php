...
a:hover { color:#f60; }
#head h1 { font-size:20px;color:#fff;height:30px;margin-left:20px; }
...
<!--头部开始-->
<div id="head">
  <h1><img src="./img/logo.png" width="60" height="25" /></h1>
...
<div id="main">
  ...
  <div id="right">
    ...
    <iframe name="right" id="rightMain" src="<?php echo url('index/my'); ?>" frameborder="false" scrolling="auto" style="border:none;" width="100%" allowtransparency="true"></iframe>
  </div>
</div>
